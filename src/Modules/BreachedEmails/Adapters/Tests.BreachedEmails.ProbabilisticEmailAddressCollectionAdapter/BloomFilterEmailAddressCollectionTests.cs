...
namespace GenePlanet.HaveIBeenBreached.Tests.BreachedEmails.ProbabilisticEmailAddressCollectionAdapter
{
    [TestFixture]
    public class BloomFilterEmailAddressCollectionTests
    {
        private readonly IEmailAddressCollection _authority;
        private readonly OptionsWrapper<ProbabilisticEmailAddressCollectionOptions> _options;

        public BloomFilterEmailAddressCollectionTests()
        {
            ...
            _options = new OptionsWrapper<ProbabilisticEmailAddressCollectionOptions>(new()
            {
        ...
        {
            var sut = new BloomFilterEmailAddressCollection(_options, _authority);
